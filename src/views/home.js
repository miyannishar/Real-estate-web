  ...
  return (
    <div className="home-container">
          ...
          <div className="home-header-container">
            <div className="home-header">
              <h1 className="home-heading">
                ...
                <span className="home-text06">The Binge</span>
                <br></br>
              </h1>
            </div>
            <p className="home-caption">
              We help you have an impactful digital presence.
            </p>
          </div>
      ...
      <section className="home-note">
        ...
        We are the lens that reveals the soul of every home. Where real estate meets reel estate: Our videos redefine the art of property presentation.
        </h2>
      </section>
      <section className="home-statistics">
        <div className="home-content">
          <div className="home-stat">
            <h3 className="home-header01">Videography</h3>
          ...
          <div className="home-stat1">
            <h3 className="home-header02">Social Media</h3>
            {/* <span className="home-caption03">Unde omnis iste</span> */}
          </div>
          <div className="home-stat2">
            <h3 className="home-header03">Advertising</h3>
      ...
      <section className="home-slider">
        <div className="home-header04">
          <h2 className="home-heading01">
            <span>​Let's Make Your Property the Talk of the Town!</span>
        ...
        <div className="home-selector">
          ...
          Transform your listings into unforgettable experiences with our cinematic real estate videos. Captivate your audience and elevate your brand today
            <span
              dangerouslySetInnerHTML={{
                __html: ' ',
              }}
      ...
      <section className="home-get-started">
        <div className="home-header-container1">
          <div className="home-header09">
            ...
            Introducing "The Binge" – your go-to hub for real estate videography excellence. We specialize in delivering a spectrum of integrated marketing services that not only surpass your wildest expectations but also drive your brand to new heights of success. Our passion lies in curating unforgettable experiences for your brand, turning your visions into tangible realities. At The Binge, we're obsessed with crafting unparalleled solutions, infusing every project with innovation, creativity, and strategic brilliance that sparks conversations and captivates audiences. Experience the madness of real estate videography with us – all within the confines of our creative MADHOUSE!
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
                }}
        ...
        <img alt="image" src="photo.jpg" className="home-image05" />
      </section>
          ...
          <div className="home-main">
            ...
            <div className="home-links">
              ...
              <div className="home-column4">
                <span className="home-header31">Contact Us</span>
